...
for progname in prognames:
    ...
    #print(k_step_varmap)
    cnf_list_init, cnf_str_init = generate_init_DIMACS_formula(init_states,init_varmap)
    #print(cnf_list_init)
    DIMACS_file = 'cnf-out'
    ...
    # Reverse mapping for easier lookup (mapping x1 to x1_7, etc.)
    reverse_mapping = {
        'x1': 'x1_3',
        'x2': 'x2_5',
        'x3': 'x3_3',
    ...
    state_counter_examples = [convert_to_decimal(state) for state in counter_examples]
